          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="widget no-box">
              <h5 class="widget-title">Akses Cepat<span></span></h5>
                  <div class="thumb-content"><a href="{{ url('/about') }}" class="btn btn-secondary btn-sm">Tentang Kami</a></div> 
                  <div class="thumb-content"><a href="{{ url('/kultum') }}" class="btn btn-secondary btn-sm">Kultum</a></div> 
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <p>Copyright Kelompok 2 © {{ $year }}. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
